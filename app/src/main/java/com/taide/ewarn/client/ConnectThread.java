...
//            socket.c
        ...
        handler.sendEmptyMessage(DataMemoryManager.DEVICE_CONNECTED);   //连接成功消息
        try {
            //获取数据流
            ...
            while (true) {
                ...
                if (bytes > 0) {
                    ...
                    message.what = DataMemoryManager.GET_MSG;   //获取消息
    ...
    public void sendData(String msg) {
        ...
        if (outputStream != null) {
            try {
                ...
                Message message = Message.obtain();
                message.what = DataMemoryManager.SEND_MSG_SUCCSEE;
                Bundle bundle = new Bundle();
                ...
                e.printStackTrace();
                Message message = Message.obtain();
                message.what = DataMemoryManager.SEND_MSG_ERROR;
                Bundle bundle = new Bundle();
                bundle.putString("MSG", new String(msg));
                message.setData(bundle);
                handler.sendMessage(message);
